...
public class MiniMaxGame {
    ...
    static ArrayList<node2> immidiateMoves = new ArrayList<>(); //global array to store the first ply nodes.(all the positions after 1 move)
    static int inputPly;
    ...
    public static void main(String[] args) throws IOException {
        ...
        node2 a = (maxMin(root, inputPly));
        String answer = getAnswer(immidiateMoves, a.value);
       // System.out.println(a.value + answer);
    ...
    static String getAnswer(ArrayList<node2> arr, int value){
    ...
    static node2 checkMax(node2 first, node2 second){
    ...
    static node2 checkMin(node2 first, node2 second){
    ...
    static node2 maxMin(node2 x, int ply) {
        ...
        if ((ply == 0) || (countPieces(x.position, 'B') <= 2)) {
            ...
            node2 temp = new node2("xxxxxxxxxxxxxxxxxxxxx");
    ...
    static node2 minMax(node2 x, int ply) {
