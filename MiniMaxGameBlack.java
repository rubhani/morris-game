...
public class MiniMaxGameBlack {
    ...
    static ArrayList<node6> immidiateMoves = new ArrayList<>(); //global array to store the first ply nodes.(all the positions after 1 move)
    static int inputPly;
    ...
    //generate a list of positions for a given color
    ...
    //returns number of pieces for the requested color
    ...
    static String getAnswer(ArrayList<node6> arr, int value) {
    ...
    static node6 checkMax(node6 first, node6 second) {
    ...
    static node6 checkMin(node6 first, node6 second) {
    ...
    static node6 maxMin(node6 x, int ply) {
        ...
        if ((ply == 0) || (countPieces(x.position, 'B') <= 2)) {
            ...
            for (int i = 0; i < children.size(); i++) {
                node6 child = new node6(children.get(i));
    ...
    static node6 minMax(node6 x, int ply) {
        ...
        if ((ply == 0) || (countPieces(x.position, 'W') <= 2)) {
            ...
            for (int i = 0; i < children.size(); i++) {
                ...
                if (ply == inputPly) {
                    node6 comeOOOOn = new node6(children.get(i));
