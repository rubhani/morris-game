...
public class MiniMaxOpening {
    ...
    static ArrayList<node1> immidiateMoves = new ArrayList<>();  //global array to store the first ply nodes.(all the positions after 1 move)
    static int inputPly;
    ...
    //graphic representation of the string
    ...
    static String getAnswer(ArrayList<node1> arr, int value){
    ...
    static node1 checkMax(node1 first, node1 second){
    ...
    static node1 checkMin(node1 first, node1 second){
    ...
    //the maxMin function
    static node1 maxMin(node1 x, int ply) {
    ...
    //minMax function
    static node1 minMax(node1 x, int ply) {
